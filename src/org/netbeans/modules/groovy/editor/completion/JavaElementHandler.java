...
public final class JavaElementHandler {
    ...
    public Map<MethodSignature, ? extends CompletionItem> getMethods(String className,
        ...
        try {
 System.out.println("RRRRRRRRRRRRRRR JavaElementHandle BEFORE runUserActionTask");
 ...
 System.out.println("RRRRRRRRRRRRRRR JavaElementHandle ERROR");
            ...
            if (elements != null) {
                ...
                if (te != null) {
                    for (ExecutableElement element : ElementFilter.methodsIn(te.getEnclosedElements())) {
                        ...
                        String parameterString = GroovyCompletionHandler.getParameterListForMethod(element);
 System.out.println("RRRRRRRRRRRRRRR MethodCompletionHandle simpleName=" + simpleName + "; parameterString=" + parameterString + "; className=" + className);
