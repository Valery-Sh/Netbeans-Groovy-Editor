...
System.out.println("UUUUUUU getMethods META className=" + className);            
        } catch (ClassNotFoundException e) {
            LOG.log(Level.FINE, "Class.forName() failed: {0}", e.getMessage()); // NOI18N
System.out.println("1) UUUUUUU getMethods META className=" + className);                        
            return Collections.emptyMap();
        } catch (NoClassDefFoundError err) {
            LOG.log(Level.FINE, "Class.forName() failed: {0}", err.getMessage()); // NOI18N
System.out.println("2) UUUUUUU getMethods META className=" + className);                        
...
System.out.println("3) UUUUUUU getMethods META className=" + className);                        

            return result;
        }
System.out.println("4) UUUUUUU getMethods META className=" + className);                        
