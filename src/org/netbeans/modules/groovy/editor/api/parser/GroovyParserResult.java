...
public class GroovyParserResult extends ParserResult {
    ...
    private EditorParser.Sanitize sanitized;
    private ErrorCollector errorCollector;  // keep track of pending errors (if any)
    
    private ClasspathInfo classPath;
    private JavaSource javaSource;
    
    GroovyParserResult(EditorParser parser, Snapshot snapshot, ModuleNode rootNode,
    ...
    public ClasspathInfo getClassPath() {
        return classPath;
    }

    public void setClassPath(ClasspathInfo classPath) {
     ...
     */
    void setSanitized(EditorParser.Sanitize sanitized, OffsetRange sanitizedRange, String sanitizedContents) {
        this.sanitized = sanitized;
        this.sanitizedRange = sanitizedRange;
        this.sanitizedContents = sanitizedContents;
    }

    EditorParser.Sanitize getSanitized() {
        return sanitized;
    }    
