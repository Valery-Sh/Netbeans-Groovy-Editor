...
import org.netbeans.modules.groovy.editor.api.parser.EditorParser;
...
System.out.println("SSSSSSSSSSS ROOT = " + EditorParser.sroot.getName());        
        IndexingManager.getDefault().refreshAllIndices(EditorParser.sroot);
        if (doc != null) {
